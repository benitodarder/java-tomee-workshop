...
import local.tin.tests.tomee.crud.model.domain.abstracts.AbstractDomain;
import local.tin.tests.tomee.crud.model.domain.abstracts.AbstractIdentifiable;
import local.tin.tests.tomee.crud.model.domain.errors.CommonError;
import local.tin.tests.tomee.crud.model.domain.interfaces.IMessage;
